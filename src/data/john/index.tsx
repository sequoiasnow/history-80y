  ...
  <Grid>
    <Col width={4}>
      <Row height={2}>
        <Grid>
          <Col width={2}>
            <Row height={4} img={require('./1.jpg')} />
          </Col>
          <Col width={2}>
            <Row height={4} img={require('./2.jpg')} />
          </Col>
        </Grid>
      </Row>
...
const Slide4 = () => (
  <Grid>
    <Col width={2}>
      ...
      <Row height={2}>
        <TextBox>
          Von Bruenchenhein’s work sought to colorize and mystify the bomb. In an interview with the Milwaukee journal Dean Jense writes <i>“Von Bruenchenhein did not shrink back in terror at the sight of monsters that were in all colors of hell and looked like escapees from a nightmare. He made portraits of the monsters as though he considered them to be every bit as beautiful as the full-thighed Venuses that Rubens painted”. </i> The article also summarizes the mission Von Bruenchenhein had of bringing to light the strange side of the “apocalypse” as he called it. His work can be
        </TextBox>
      </Row>
    </Col>
    <Col width={2}>
